        ...
        FastAutoGenerator.create(url, username, password)
                .globalConfig(builder -> {
                    builder.author("WuSJ") // 设置作者
                            ...
                            .outputDir(jarPath + "/src/main/java/com/pzhu/house/utils/mp"); // 指定输出目录
                })
                .packageConfig(builder -> {
                    builder.parent("") // 设置父包名
                            .entity("model")
                            .pathInfo(Collections.singletonMap(OutputFile.xml, jarPath + "/src/main/resources/mapper/house")); // 设置mapperXml生成路径
                })
